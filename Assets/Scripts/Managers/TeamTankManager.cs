...
public class TeamTankManager
{
    ...
    [HideInInspector] public TeamTankMovement m_Movement;        // References to various objects for control during the different game phases.
    [HideInInspector] public TeamTankShooting m_Shooting;
    [HideInInspector] public TeamTankHealth m_Health;
    [HideInInspector] public TeamTankSetup m_Setup;
    ...
    public void Setup()
    {
        ...
        m_Movement = m_Instance.GetComponent<TeamTankMovement>();
        m_Shooting = m_Instance.GetComponent<TeamTankShooting>();
        m_Health = m_Instance.GetComponent<TeamTankHealth>();
        m_Setup = m_Instance.GetComponent<TeamTankSetup>();
