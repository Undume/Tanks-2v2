...
public class TankManager
{
    ...
    [HideInInspector] public TankMovement m_Movement;        // References to various objects for control during the different game phases.
    [HideInInspector] public TankShooting m_Shooting;
    [HideInInspector] public TankHealth m_Health;
    [HideInInspector] public TankSetup m_Setup;
