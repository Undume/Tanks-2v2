...
public class TeamTankHealth : NetworkBehaviour
{
    ...
    public TeamTankSetup m_Setup;
    public TeamTankManager m_Manager;                   //Associated manager, to disable control when dying.
